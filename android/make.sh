...
export APP_NAME_RELEASE="Caramelo Dash"
...
export APP_NAME_BETA="Caramelo Dash Beta"
...
export APP_NAME_DEBUG="Caramelo Dash Debug"
...
PO_EXTRACT_ERROR_MSG_STR="Check remaining device space or reinstall Caramelo Dash."
PO_QUIT="po_quit"
PO_QUIT_STR="Quit"
